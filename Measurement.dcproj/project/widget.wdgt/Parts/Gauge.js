 ...
 *  
 */
DC.Gauge= Class.create(DC.DashcodePart, {

    __viewClassName__: "Gauge",

    exposedBindings: ['value','minValue','maxValue','onValue','warningValue','criticalValue'],
    ...
    partSetup: function(spec)
    {
        ...
        this.continuous = spec.continuous; // Fire onchanged live, as opposed to onmouseup
        
        this.value = spec.value?spec.value:0;
        ...
        this._init(spec.value || 0, spec.minValue || 0, spec.maxValue || 0, spec.onValue || 0, spec.warningValue || 0, spec.criticalValue || 0, spec.startAngle || 0, spec.stopAngle || 0, spec.pivotOffsetX || 0, spec.pivotOffsetY || 0, spec.pointerReach || 0, spec.interactive || false, spec.imagePointer || null, spec.imageOff || null, spec.imageOn || null, spec.imageWarning || null, spec.imageCritical || null, spec.baseImagesPath || null);
    },
    ...
    setStopAngle: function(newValue)
    {
    ...
    setPivotOffsetX: function(newValue)
    {
        this.pivotOffsetX = newValue;
        this.needsDisplay = true;
    },

    setPivotOffsetY: function(newValue)
    {
        this.pivotOffsetY = newValue;
        this.needsDisplay = true;
    },

    setPointerReach: function(newValue)
    {
    ...
    refresh: function()
    {	        
        if (this._fishedLoading && !this._imagesToPreLoad) {
...
//            this.onchanged(this.value);
    ...
    preLoadAnImage: function(imagePath, propertyKey)
    {
        var _self = this;
    ...
    preLoadImages:function()
    {
        ...
        var base = this._baseImagesPath;
        this.preLoadAnImage(base + this._imageOnPath,       "_imageOn");
        this.preLoadAnImage(base + this._imageOffPath,      "_imageOff");
        this.preLoadAnImage(base + this._imageWarningPath,  "_imageWarning");
        this.preLoadAnImage(base + this._imageCriticalPath, "_imageCritical");
        this.preLoadAnImage(base + this._imagePointerPath,  "_imagePointer");
    },
    ...
    _init: function(value, minValue, maxValue, onValue, warningValue, criticalValue, startAngle, stopAngle, pivotOffsetX, pivotOffsetY, pointerReach, interactive, imagePointer, imageOff, imageOn, imageWarning, imageCritical, baseImagesPath)
    {
        ...
        this._onPreLoadComplete = function () { this._fishedLoading = true; _self.refresh(); };
        this._setBaseImagesPath(baseImagesPath);
    },
...
// Capture events that we don't handle but also don't want getting through
    ...
    _mousedownCanvas: function(event)
    {	
        ...
        this.setValue(this._computeValueFromMouseEvent(event));
    },
    _mousemoveCanvas: function(event)
    {	
        this.setValueTo(this._computeValueFromMouseEvent(event));
    },
    _mouseupCanvas: function(event)
    {	
    ...
    _computeValueFromMouseEvent: function(event)
    {
        ...
        var mx = event.pageX - cx - (w / 2);
        var my = event.pageY - cy - (h / 2);
        var theta = 0;
        if (mx < 0) 
        {
